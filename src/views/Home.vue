...
<template>
  <div class="w-full flex flex-col gap-4 p-2">
    <div
      class="w-full h-[300px] max-w-[500px] rounded-lg flex flex-col justify-center gap-12 px-4 gradient-box"
    >
      <div class="flex justify-start items-center gap-4 text-3xl">
        <svg
          stroke="currentColor"
        ...
        <span :style="{ color: 'var(--button-color)' }">ቢንጎ ጌም</span>
      </div>
    ...
    <div
      class="w-full h-[200px] max-w-[500px] rounded-lg gradient-box flex justify-center items-center flex-col gap-6 text-2xl"
  ...
  <img src="../assets/play.jpg" class="w-full" alt="" />
</template>
